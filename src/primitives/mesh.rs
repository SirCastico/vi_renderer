...
use super::{
    triangle::{triangle_intersect, Face},
    Intersectable,
};
...
mod tests {
    use crate::{
        primitives::triangle::{triangle_intersect, Face},
        rays::ray::Ray,
        utils::vector::{Point, Vector},
    };
    ...
    fn triangle_intersect_test() {
        ...
        let ray = Ray::new(Point::new(1.0, 1.0, 1.0), Vector::new(0.0, 0.0, -1.0));
